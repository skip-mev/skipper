...
// TotalPairs is a free data retrieval call binding the contract method 0x5d8c32a9.
//
// Solidity: function totalPairs() view returns(uint256)
func (_UniswapV2Factory *UniswapV2FactoryCaller) TotalPairs(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _UniswapV2Factory.contract.Call(opts, &out, "totalPairs")
...
//
// Solidity: function totalPairs() view returns(uint256)
func (_UniswapV2Factory *UniswapV2FactorySession) TotalPairs() (*big.Int, error) {
	return _UniswapV2Factory.Contract.TotalPairs(&_UniswapV2Factory.CallOpts)
}

// TotalPairs is a free data retrieval call binding the contract method 0x5d8c32a9.
//
// Solidity: function totalPairs() view returns(uint256)
func (_UniswapV2Factory *UniswapV2FactoryCallerSession) TotalPairs() (*big.Int, error) {
	return _UniswapV2Factory.Contract.TotalPairs(&_UniswapV2Factory.CallOpts)
}
